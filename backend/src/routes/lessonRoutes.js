...
import { authorize, optionalProtect, protect, requireVerifiedMentor } from "../middlewares/authMiddleware.js";
...
router.get("/:id", optionalProtect, validateRequest({ params: commonSchemas.idParam }), getLessonById);
