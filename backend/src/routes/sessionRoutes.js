...
router.post("/", protect, authorize("mentor", "admin"), requireVerifiedMentor, validateRequest({ body: sessionSchemas.create }), createSession);
router.patch("/:id", protect, authorize("mentor", "admin"), requireVerifiedMentor, validateRequest({ params: commonSchemas.idParam, body: sessionSchemas.update }), updateSession);
...
router.post("/:id/start", protect, authorize("mentor", "admin"), requireVerifiedMentor, validateRequest({ params: commonSchemas.idParam }), startSession);
...
router.post("/:id/end", protect, authorize("mentor", "admin"), requireVerifiedMentor, validateRequest({ params: commonSchemas.idParam }), endSession);
...
router.get("/:id/feedback-summary", protect, authorize("mentor", "admin"), requireVerifiedMentor, validateRequest({ params: commonSchemas.idParam }), getSessionFeedbackSummary);
