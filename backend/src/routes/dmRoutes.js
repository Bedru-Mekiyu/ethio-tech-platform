...
router.post("/conversations", protect, validateRequest(createConversationSchema), createConversation);
router.get("/:conversationId/messages", protect, getConversationMessages);
router.post("/:conversationId/messages", protect, validateRequest(sendMessageSchema), sendConversationMessage);
