...
router.post("/", protect, authorize("admin", "mentor"), validateRequest({ body: projectSchemas.create }), createProject);
router.patch("/:id", protect, authorize("admin", "mentor"), validateRequest({ params: commonSchemas.idParam, body: projectSchemas.update }), updateProject);
