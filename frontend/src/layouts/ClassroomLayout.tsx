...
export function ClassroomLayout() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[radial-gradient(circle_at_top,rgba(0,210,255,0.06),rgba(5,10,20,1)_45%)]">
      <a
        href="#classroom-main"
      ...
      <header className="border-b border-[var(--border)] bg-[rgba(5,10,20,0.68)] backdrop-blur-xl">
      ...
      <div className="relative flex flex-1 overflow-hidden">
        ...
        <div className="relative flex-1" id="classroom-main">
          ...
          {/* Immersive Toolbar */}
          <div
            className="absolute bottom-4 left-4 right-4 flex max-w-4xl flex-col gap-4 rounded-2xl border border-[var(--border)] bg-[rgba(11,14,20,0.92)] px-5 py-4 shadow-[0_24px_64px_rgba(0,0,0,0.65),0_0_32px_rgba(0,210,255,0.03)] backdrop-blur-xl md:bottom-6 md:left-1/2 md:right-auto md:w-[calc(100%-3rem)] md:-translate-x-1/2 md:flex-row md:items-center"
            role="toolbar"
