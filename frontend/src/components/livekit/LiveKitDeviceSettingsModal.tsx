...
export interface DeviceSettingsModalRef {
  loadDevices: () => Promise<void>;
}

export const LiveKitDeviceSettingsModal = forwardRef<DeviceSettingsModalRef, LiveKitDeviceSettingsModalProps>(
  ({ isOpen, onClose, room }, ref) => {
