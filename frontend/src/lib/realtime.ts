...
export interface SocketClientToServerEvents {
  ...
  "chat:message": (payload: OutboxMessage, ack?: (response: { ok: boolean; messageId?: string }) => void) => void;
