...
function RubricModal({ application, onClose, onApplyRubricNotes }: RubricModalProps) {
  ...
  const [scores, setScores] = useState<RubricScores>(() =>
    application ? autoEvaluateApplication(application) : { experience: 3, techStack: 3, commitment: 3, motivation: 3 },
  );
...
export function AdminModerationPage() {
  ...
  return (
    <div className="space-y-6 text-[var(--text-primary)]">
      ...
      <InterviewModal application={activeInterviewApp} onClose={() => setActiveInterviewApp(null)} />
