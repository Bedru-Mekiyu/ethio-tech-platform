    ...
    <div className="space-y-4 rounded-2xl border border-zinc-200/80 bg-white p-4 sm:p-5 shadow-sm">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-zinc-900">Lesson Assessment Quiz</h3>
        </div>
      ...
      {questions.length === 0 ? (
        ...
        <div className="space-y-4">
          {questions.map((q, qIndex) => (
            <div key={qIndex} className="rounded-xl border border-zinc-200/90 bg-zinc-50/60 p-4 space-y-3">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1">
                  <Button
                    ...
                    className="h-7 w-7 text-zinc-500 hover:text-zinc-700 hover:bg-zinc-100"
                    title="Move up"
                  >
                    <ChevronUp size={14} />
                  </Button>
              ...
              <div className="space-y-2 pt-1">
                <span className="text-xs text-zinc-500 block">Options (select radio for correct answer):</span>
                {q.options.map((opt, optIndex) => (
                  <div key={optIndex} className="flex items-center gap-2">
                    <input
                      ...
                      className="h-4 w-4 text-zinc-900 focus:ring-zinc-900 border-zinc-300 cursor-pointer"
