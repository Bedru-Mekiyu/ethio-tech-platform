...
export function CodeSandboxStarterEditor({
  ...
  return (
    <div className="space-y-4 rounded-2xl border border-zinc-200/80 bg-white p-4 sm:p-5 shadow-sm">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Code2 size={18} className="text-zinc-900" />
          <h3 className="text-sm font-semibold text-zinc-900">Code Lab & Sandbox Environment</h3>
        </div>
        {codeSandboxUrl && (
          <a
            href={codeSandboxUrl}
      ...
      <div className="space-y-1.5">
        <label htmlFor="sandbox-url" className="block text-xs font-medium text-zinc-700">
      ...
      <div className="space-y-2">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <label htmlFor="starter-code" className="block text-xs font-medium text-zinc-700">
          ...
          <div className="flex items-center gap-2">
            ...
            {TEMPLATES.map((tmpl) => (
              <button
                ...
                className="rounded-md border border-zinc-200 bg-zinc-50 px-2 py-0.5 text-[10px] font-medium text-zinc-700 hover:bg-zinc-100 hover:text-zinc-900 transition-colors"
              >
                {tmpl.label}
              </button>
            ))}
        ...
        <Textarea
          ...
          rows={6}
          className="font-mono text-xs leading-relaxed bg-zinc-950 text-zinc-200 border-zinc-800 focus:border-zinc-400 focus:ring-zinc-400"
        />
      </div>
