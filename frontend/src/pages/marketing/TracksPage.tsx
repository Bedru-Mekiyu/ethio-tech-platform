...
export function TracksPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden border-b border-slate-200 bg-slate-50/70 py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 lg:px-8 relative z-10">
          <div className="mx-auto max-w-4xl text-center space-y-5">
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50/80 px-3 py-1 text-xs font-medium text-indigo-700"
            >
            ...
            >
              ...
              <span className="text-indigo-600">Production Capstones</span> & Mentorship
            </motion.h1>
            ...
            <motion.p
              ...
              className="mx-auto max-w-2xl text-xs sm:text-sm text-slate-600 leading-relaxed font-normal"
            >
            ...
            >
              <Card className="border-slate-200 bg-white p-3 text-center shadow-xs">
                ...
                <p className="mt-0.5 text-[10px] uppercase tracking-wider text-slate-500 font-semibold">Core Tracks</p>
              </Card>
              <Card className="border-slate-200 bg-white p-3 text-center shadow-xs">
                <p className="text-xl font-bold text-indigo-600">{totalCapstones}+</p>
                <p className="mt-0.5 text-[10px] uppercase tracking-wider text-slate-500 font-semibold">
                  Real Capstones
                </p>
              </Card>
              <Card className="border-slate-200 bg-white p-3 text-center shadow-xs">
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="relative w-full lg:max-w-md">
              ...
              <Input
                ...
                className="pl-9 h-10 bg-white border-slate-300 text-xs rounded-lg text-slate-900 placeholder:text-slate-400 focus:border-indigo-500 shadow-xs"
              />
              {searchQuery && (
                <button
                  type="button"
            ...
            {filteredTracks.map((track) => {
              ...
              return (
                <Card
                  key={track.id}
                  id={track.id}
                  className="group relative overflow-hidden rounded-xl border-slate-200 bg-white p-6 md:p-8 transition duration-150 hover:border-slate-300 shadow-xs hover:shadow-sm"
                >
                  <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="space-y-1">
                        <h2 className="text-xl md:text-2xl font-bold text-slate-900 tracking-tight">{track.title}</h2>
                        <p className="text-xs md:text-sm leading-relaxed text-slate-600">{track.tagline}</p>
                      </div>

                      {/* Key stats bar */}
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 rounded-lg border border-slate-200 bg-slate-50 p-3 text-center">
                        <div>
                      ...
                      <div className="space-y-2.5">
                        <div className="flex items-center justify-between">
                          <h3 className="text-[10px] font-semibold uppercase tracking-wider text-indigo-700 flex items-center gap-1.5">
                            <Code2 size={13} />
                        ...
                        <div className="grid gap-2.5 sm:grid-cols-2">
                          {track.capstones.map((capstone) => (
                            <button
                              ...
                              className="group/cap text-left rounded-lg border border-slate-200 bg-slate-50 p-3 transition hover:border-slate-300 hover:bg-slate-100/60"
                            >
                              ...
                              <h4 className="mt-1.5 text-xs font-semibold text-slate-900 group-hover/cap:text-indigo-600 transition line-clamp-1">
                                {capstone.title}
                              </h4>
                              ...
                              <div className="mt-2 flex flex-wrap gap-1">
                                {capstone.techStack.slice(0, 3).map((tech) => (
                                  <span
                                    key={tech}
                                    className="rounded bg-white border border-slate-200 px-1.5 py-0.5 text-[9px] text-slate-600 shadow-2xs"
                                  >
                                    {tech}
                                  </span>
                                ))}
                                {capstone.techStack.length > 3 && (
                                  <span className="rounded bg-white border border-slate-200 px-1 py-0.5 text-[9px] text-slate-500">
                                    +{capstone.techStack.length - 3}
                                  </span>
                                )}
                              </div>
                    ...
                    <div className="flex flex-col justify-between gap-4">
                      ...
                      <div className="relative overflow-hidden rounded-xl border border-slate-200 aspect-[16/10] sm:aspect-[2/1] lg:aspect-[16/10]">
                        <SmartImage
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 pt-1">
                        <button
                          ...
                          className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-200 bg-white px-4 py-2 text-xs font-medium text-slate-700 transition hover:border-slate-300 hover:text-slate-900 shadow-2xs"
                        >
                          <BookOpen size={14} />
                  ...
                  {isSyllabusExpanded && (
                    <motion.div
                      ...
                      className="mt-6 border-t border-slate-200 pt-5 space-y-4"
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          >
                            ...
                            <div className="space-y-1 pt-1.5 border-t border-slate-200">
                              {module.lessons.map((lesson, lIdx) => (
                                <div
                                  key={lesson._id}
                                  className="flex items-center justify-between text-xs py-1.5 px-2.5 rounded-md bg-white border border-slate-200 shadow-2xs"
                                >
                                  <span className="text-slate-800 truncate font-medium">
                                    {mIdx + 1}.{lIdx + 1} {lesson.title}
                                  </span>
                                  <span className="text-[10px] text-indigo-600 font-medium shrink-0 ml-2 font-mono">
      ...
      <section className="border-t border-slate-200 bg-slate-50/50 py-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            <Card className="border-slate-200 bg-white p-5 space-y-2.5 shadow-xs">
      ...
      {/* CTA Footer Banner */}
      <section className="relative overflow-hidden border-t border-slate-200 bg-white py-14 text-center">
        <div className="mx-auto max-w-2xl px-4 space-y-4">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-3 text-[11px] text-slate-600">
            <span className="flex items-center gap-1">
              <CheckCircle2 size={12} className="text-emerald-600" /> No credit card required
            </span>
            <span className="flex items-center gap-1">
              <CheckCircle2 size={12} className="text-emerald-600" /> 6 Physical regional hubs
            </span>
            <span className="flex items-center gap-1">
              <CheckCircle2 size={12} className="text-emerald-600" /> Verifiable on-chain certs
            </span>
          </div>
        </div>
      </section>
